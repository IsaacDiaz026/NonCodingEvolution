...
write.table(noncoding_genic, "ACRs_classified/Noncoding_genic_ACRs.bed", sep = "\t",col.names=F, row.names=F, quote=F)

write.table(coding_genic, "ACRs_classified/Species_level/Coding_genic_ACRs.bed", sep = "\t",col.names=F, row.names=F, quote=F)


write.table(genic, "ACRs_classified/Genic_ACRs.bed", sep ="\t", col.names=FALSE, row.names=FALSE,quote=FALSE)
write.table(proximal, "ACRs_classified/Proximal_ACRs.bed",sep="\t",col.names = FALSE, row.names=FALSE,quote =FALSE)
write.table(distal, "ACRs_classified/Distal_ACRs.bed",sep="\t",col.names = FALSE, row.names=FALSE,quote =FALSE)
...
pdf("ACRs_classified/ACR_size_byfreq.pdf")
...
pdf("ACRs_classified/2023-10-19_proportion_acr_class.pdf")
...
write.table(ACRs_classified, "ACRs_classified/ACRs_classified_freq_type.txt",sep="\t",quote=F, row.names = F, col.names = T)
